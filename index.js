...
function check_number() {
  ...
  document.getElementById("count_it").innerHTML =
    "This is your test number:" + counter;

  nr_game = document.getElementById("nr_game").value;
  if (nr_game == number) {
    alert(
      "You are the winner :D. " + "You guest after" + counter-- + " times!"
    );
    ...
    document.getElementById("answer").innerHTML = "Write the number";
  } else if (nr_game.indexOf(",") != -1 || nr_game.indexOf(".") != -1) {
    document.getElementById("answer").innerHTML =
      "This is NOT a natural number";
  } else if (nr_game > number) {
    document.getElementById("answer").innerHTML =
      "I am thinking about lower number";
  } else if (nr_game < number) {
    document.getElementById("answer").innerHTML =
      "I am thinking about higher number";
  } else if (isNaN(nr_game)) {
    document.getElementById("answer").innerHTML =
      "Are you sure that this is a number?";
  }
